...
# Classes
class riscv64_linux_gcc_nolibc(GenericEnvironment):
    ...
    def __init__(self, isa):
        ...
        self._default_wrapper = "CWrapperNoLibC"
    ...
    def elf_abi(self, stack_size, start_symbol, **kwargs):
        ...
        return super(riscv64_linux_gcc_nolibc, self).elf_abi(
