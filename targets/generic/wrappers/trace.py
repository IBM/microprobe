...
class QTrace(microprobe.code.wrapper.Wrapper):
    ...
    def __init__(
        ...
        init_data_address: Union[int, None] = 0x01600000,
        reset: bool = False,
    ):
    ...
    def outputname(self, name: str):
        ...
        """
        if (not name.endswith(".qt") and not name.endswith(".qt.bz2")
                and not name.endswith("qt.gz")):
            return "%s.qt" % name
    ...
    def wrap_ins(self,
                 instr: Instruction,
                 next_instr: Union[Instruction, None] = None,
                 show: bool = False):
        """
