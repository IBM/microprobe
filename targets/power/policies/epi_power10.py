...
SUPPORTED_TARGETS = [
    ...
    "power_v310-power10-ppc64le_linux_gcc",
    "power_v310-power10-ppc64_cronus",
    "power_v310-power10-ppc64_mesa",
]
...
def policy(target, wrapper, **kwargs):
    ...
    if not accinit:
        acc_registers = [
            rname for rname in target.registers if rname.startswith("ACC")
        ]
        synthesizer.add_pass(
    ...
    if not synthesizer.wrapper.context().symbolic or instr.mnemonic in [
        "BLA",
        "BA",
        "BCLA",
        "BCA",
